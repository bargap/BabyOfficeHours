...
- **Entitlements File**: `Config/BabyOfficeHours.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/BabyOfficeHours.entitlements`:
